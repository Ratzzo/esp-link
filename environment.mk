...
XTENSA_TOOLS_ROOT=$(strip $(ESP_OPEN_SDK_ROOT))xtensa-lx106-elf/bin/
...
export PATH := $(strip $(OPEN_SDK_BASE))/binfixes:$(strip $(XTENSA_TOOLS_ROOT)):$(PATH) #shove binary paths into PATH
