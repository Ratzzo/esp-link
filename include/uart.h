...
void uart_init(uint32 conf0, UartBaudRate uart0_br, UartBaudRate uart1_br);
...
void uart_config(uint8 uart_no, UartBaudRate baudrate, uint32 conf0);

void ICACHE_FLASH_ATTR uart0_sendStr(const char *str);
void ICACHE_FLASH_ATTR uart0_muxed_printf(int muxdirection, const char *fmt, ...);
